...
module.exports = function(h) {
  ...
  return (classes) => {
    ...
    data.map((row, index) => {
      ...
      rows.push(<tr {...{attrs: rowAttributes}} class={`VueTables__row ${rowClass}`} on-click={this.rowWasClicked.bind(this, row, index)} on-contextmenu={this.rowContextmenu.bind(this, row, index)}>{columns}</tr>);
