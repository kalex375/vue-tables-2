module.exports =   {
      ...
      setPage: require('../methods/set-page'),
          setNextPage: require('../methods/set-next-page'),
    setPrevPage: require('../methods/set-prev-page'),
    countMessage: require('../methods/count-message'),
      ...
      rowWasClicked:require('../methods/row-was-clicked'),
          rowContextmenu: require('../methods/row-contextmenu'),
